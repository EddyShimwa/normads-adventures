...
const BlogsMain = () => {
  ...
  return (
<section className="blogs px-5 py-10 dark:bg-gray-100 dark:text-gray-800 h-screen">
  <div>
  <div className="inline-block flex justify-center p-5">
  <h1 className="text-2xl uppercase font-bold text-center py-4 border-b-2 border-green-500 pb-1">Our Blogs</h1>
</div>
	<div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
			...
			<div className="flex flex-col space-y-8 md:space-y-12">
				<div className="flex flex-col space-y-2">
					<h3 className="flex items-center space-x-2 dark:text-gray-600">
						<span className="flex-shrink-0 w-2 h-2 uppercase rounded-full dark:bg-green-600"></span>
					...
					<p className="text-xs dark:text-gray-600">47 minutes ago by
						<a rel="noopener noreferrer" href="#" className="hover:underline dark:text-green-600">Leroy Jenkins</a>
					</p>
				</div>
				<div className="flex flex-col space-y-2">
					<h3 className="flex items-center space-x-2 dark:text-gray-600">
				...
				<div className="flex flex-col space-y-2">
					...
					<p className="text-xs dark:text-gray-600">4 hours ago by
						<a rel="noopener noreferrer" href="#" className="hover:underline dark:text-green-600"> Paul Lorris </a>
					</p>
				</div>
			</div>
			<div className="flex flex-col w-full space-y-2">
				<div className="flex w-full h-1 bg-opacity-10 dark:bg-green-600">
					<div className="w-1/2 h-full dark:bg-green-600"></div>
				</div>
				<a rel="noopener noreferrer" href="#" className="flex items-center justify-between w-full">
					...
					<svg viewBox="0 0 24 24" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" className="w-4 strokeCurrent dark:text-green-600">
		...
		<div className="relative flex col-span-12 dark:bg-gray-500 bg-center bg-no-repeat bg-cover xl:col-span-6 lg:col-span-5 md:col-span-9 min-h-96" style={{backgroundImage: "url('https://source.unsplash.com/random/239x319')"}}>
			<span className="absolute px-1 pb-2 text-xs font-bold uppercase border-b-2 left-6 top-6 dark:text-gray-800 dark:border-green-600">Nyungwe, Forest</span>
        ...
        <img src="https://rwandaecocompany.com/wp-content/uploads/2021/09/nyungwe-forests.jpg"/>
		...
		<div className="hidden py-2 xl:col-span-3 lg:col-span-4 md:hidden lg:block">
			<div className="mb-8 space-x-5 border-b-2 border-opacity-10 dark:border-green-600">
				<button type="button" className="pb-5 text-xs font-bold uppercase border-b-2 dark:border-green-600">Latest</button>
